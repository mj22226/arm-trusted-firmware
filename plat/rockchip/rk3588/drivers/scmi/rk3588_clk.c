...
static struct pvtpll_table rk3588_cpul_pvtpll_table[] = {
	...
	ROCKCHIP_PVTPLL(1704000000, 1, 16),
	ROCKCHIP_PVTPLL(1608000000, 1, 16),
	ROCKCHIP_PVTPLL(1416000000, 1, 16),
	ROCKCHIP_PVTPLL(1296000000, 1, 18),
	ROCKCHIP_PVTPLL(1200000000, 1, 19),
	ROCKCHIP_PVTPLL(1008000000, 1, 25),
	ROCKCHIP_PVTPLL(816000000, 1, 36),
...
static struct pvtpll_table rk3588_cpub0_pvtpll_table[] = {
	/* rate_hz, ring_sel, length */
	ROCKCHIP_PVTPLL(2016000000, 1, 12),
	ROCKCHIP_PVTPLL(1896000000, 1, 12),
	ROCKCHIP_PVTPLL(1800000000, 1, 12),
	ROCKCHIP_PVTPLL(1608000000, 1, 12),
	ROCKCHIP_PVTPLL(1416000000, 1, 13),
	ROCKCHIP_PVTPLL(1200000000, 1, 18),
	ROCKCHIP_PVTPLL(1008000000, 1, 25),
	ROCKCHIP_PVTPLL(816000000, 1, 35),
	ROCKCHIP_PVTPLL(600000000, 0, 0),
	ROCKCHIP_PVTPLL(408000000, 0, 0),
	{ /* sentinel */ },
};
...
static struct pvtpll_table rk3588_gpu_pvtpll_table[] = {
	/* rate_hz, ring_sel, length */
	ROCKCHIP_PVTPLL(850000000, 1, 13),
	ROCKCHIP_PVTPLL(800000000, 1, 13),
	ROCKCHIP_PVTPLL(700000000, 1, 17),
	ROCKCHIP_PVTPLL(600000000, 1, 24),
	ROCKCHIP_PVTPLL(500000000, 1, 35),
	ROCKCHIP_PVTPLL(400000000, 1, 49),
	ROCKCHIP_PVTPLL(300000000, 1, 63),
...
static struct pvtpll_table rk3588_npu_pvtpll_table[] = {
	/* rate_hz, ring_sel, length */
	ROCKCHIP_PVTPLL(950000000, 1, 13),
	ROCKCHIP_PVTPLL(900000000, 1, 13),
	ROCKCHIP_PVTPLL(850000000, 1, 13),
	ROCKCHIP_PVTPLL(800000000, 1, 13),
	ROCKCHIP_PVTPLL(700000000, 1, 17),
	ROCKCHIP_PVTPLL(600000000, 1, 24),
...
static unsigned long rk3588_cpul_rates[] = {
	...
	1200000000, 1416000000, 1608000000, 1704000000,
};
...
static unsigned long rk3588_gpu_rates[] = {
	...
	600000000, 700000000, 800000000, 850000000
};

static unsigned long rk3588_npu_rates[] = {
	200000000, 300000000, 400000000, 500000000,
...
rk_scmi_clock_t clock_table[] = {
	...
	RK3588_SCMI_CLOCK(SCMI_CLK_NPU, "scmi_clk_npu", &clk_scmi_npu_ops, rk3588_npu_rates, ARRAY_SIZE(rk3588_npu_rates), false),
